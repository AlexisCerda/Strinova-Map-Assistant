        ...
        <div style={{ display: "flex", height: "100%" }}>
          <div style={{ height: "360px", width: "200px",display:"flex relative" }}>
            ...
            <div style={{ position: "absolute", left: "40px", bottom: "110px", height: "25px", display: "flex", alignContent: "center", filter: "drop-shadow(0 0 5px rgba(var(--semi-grey-7))" }}>
              {currentLanguage.characterInfo[data.id].Type == currentLanguage.characterTypes.Duellist ? <img draggable="false" src="/images/remote/5b67126e_c7QDINMXFyuav6b.png" style={{ filter: "invert(100%)", height: "25px" }} /> : <></>}
              {currentLanguage.characterInfo[data.id].Type == currentLanguage.characterTypes.Support ? <img draggable="false" src="/images/remote/8c8b894f_seAIvkZLtWGrlwd.png" style={{ filter: "invert(100%)", height: "25px" }} /> : <></>}
              {currentLanguage.characterInfo[data.id].Type == currentLanguage.characterTypes.Controller ? <img draggable="false" src="/images/remote/469cdf99_oLVSxJBTrynRv7F.png" style={{ filter: "invert(100%)", height: "25px" }} /> : <></>}
              {currentLanguage.characterInfo[data.id].Type == currentLanguage.characterTypes.Sentinel ? <img draggable="false" src="/images/remote/b3034b3b_jEuQg1bt2veBrTP.png" style={{ filter: "invert(100%)", height: "25px" }} /> : <></>}
              {currentLanguage.characterInfo[data.id].Type == currentLanguage.characterTypes.Initiator ? <img draggable="false" src="/images/remote/54430e3d_OfZRtlo2ICDKNHG.png" style={{ filter: "invert(100%)", height: "25px" }} /> : <></>}
